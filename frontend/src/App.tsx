...
import SLAMonitoring from './pages/admin/SLAMonitoring';

// Agent Pages
import AgentDashboard from './pages/agent/AgentDashboard';
import AgentTasks from './pages/agent/AgentTasks';
import DeliveryProofForm from './pages/agent/DeliveryProofForm';
...
const App: React.FC = () => {
  return (
    <Routes>
      ...
      {/* Admin Routes */}
      <Route element={<ProtectedRoute allowedRoles={[UserRole.ADMIN, 'operations_manager' as UserRole]} />}>
        <Route element={<DashboardLayout />}>
          <Route path="/admin" element={<AdminDashboard />} />
          <Route path="/admin/users" element={<ManageUsers />} />
          <Route path="/admin/shipments" element={<ManageShipments />} />
          <Route path="/admin/analytics" element={<Analytics />} />
          <Route path="/admin/smart-assignment" element={<SmartAssignment />} />
          <Route path="/admin/exceptions" element={<ExceptionCenter />} />
      ...
      <Route element={<ProtectedRoute allowedRoles={[UserRole.AGENT]} />}>
        <Route element={<DashboardLayout />}>
          ...
          <Route path="/agent/delivery-proof/:id" element={<DeliveryProofForm />} />
        </Route>
      </Route>
