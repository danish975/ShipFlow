...
const updateStatusSchema = z.object({
  body: z.object({
    status: z.enum(['CREATED', 'ASSIGNED', 'PICKED_UP', 'IN_TRANSIT', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED']),
  }),
});
 ...
 */
router.patch('/:id/status', authenticate, authorize(UserRole.AGENT, UserRole.ADMIN), validate(updateStatusSchema), updateStatus);
